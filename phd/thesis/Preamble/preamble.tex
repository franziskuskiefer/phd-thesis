...
\usepackage{multirow}
\renewcommand{\arraystretch}{1.15} % change row height for booktabs
...
\newcommand{\lllongleftrightarrow}{\overleftarrow{\qquad\qquad\hspace{0.25em}}\hspace{-0.25em}\overrightarrow{\qquad\qquad}}
