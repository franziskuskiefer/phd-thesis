...
\section{Trapdoor D-SPHF}\label{sec:tdsphf}
...
\subsection{Cramer-Shoup TD-SPHF}\label{sec:cs-tdsphf}
...
% 2-Server PAKE in UC
%==============================================================================
\section{UC-secure Two Server PAKE}\label{sec:2pake}
...
\subsection{The Protocol}\label{sec:2pakeprotocol}
% \fk{add figure}
...
\subsection{UC Security Model for Two Server PAKE}\label{sec:2pakesecurity}
...
\subsection{Security}\label{sec:2pakeproof}
...
\subsubsection{Sequence of Games}
...
\section{\FTWOPAKE Discussion}\label{app:relations}
...
\subsection{\FTWOPAKE and the BPR 2PAKE Model}
