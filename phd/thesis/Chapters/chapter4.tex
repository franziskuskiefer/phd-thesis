...
This first leg of the framework introduced the notion of \ac{2BPR}.
\ac{2BPR} is a solution for secure registration of policy-compliant, user-selected passwords for \ac{2PAKE}/\ac{PPSS} protocols where each server is supposed to learn only its own share of the password and whether the combined password is conform with his password policy.
...
To this end this chapter introduced \ac{TD-SPHF} and the first definition of \ac{UC} security for \ac{2PAKE} protocols.
