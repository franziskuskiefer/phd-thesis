...
\node[party,align=center,text width=11em] (server) at (9.5,-4.2) {\uline{$S_b~ (\cC,S_{1-b}, f=f_0\cap f_1, \crs)$}};
...
\game{1} In this game we change how $\Send_\cC(\cC_i, S_{b,j}, m)$ queries are answered.
