\section{Zero-knowledge Password Policy Checks and\\ Policy Compliant Passwords Registration} \label{sec:zkppc}
...
%This leads to four sets $\Omega_d,\Omega_s,\Omega_u,\Omega_l$ for the four \ac{ASCII} subsets $d,s,u,l$ and a fifth set $\Omega_\sigma$ for all characters, i.e. $\Omega'=\Sigma$.
%
%The \ac{ZKPPC} framework is depicted in Figure \ref{fig:zkpconeserver}.
