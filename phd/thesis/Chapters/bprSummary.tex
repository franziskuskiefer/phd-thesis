...
\mynote{add estimation of SPC-based BPR}
...
\midrule
ZKPPC (Section \ref{sec:zkppc}) &81,287&81,268&66,944&66,925&38,496&38,477&7,710&7,699&453,574&453,529 \\
\midrule
BPR (Section \ref{sec:bpr}) & ? & ? & ? & ? & ? & ? & ? & ? & ? & ?\\
\midrule
SPC (Section \ref{sec:spc-bpr}) &140&4&243&8&454&17&223&7&275&8\\
% \hline
