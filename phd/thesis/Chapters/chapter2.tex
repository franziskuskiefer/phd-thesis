...
\subsubsection{Cramer-Shoup Encryption}\label{sec:csencryption}
...
\subsubsection{ElGamal Encryption}\label{sec:elgamalencryption}
...
\subsubsection{SPHF on Cramer-Shoup Ciphertexts}
...
\subsection{Trapdoor \SPHF (\TSPHF)}\label{sec:tsphf}
...
\subsubsection{\TSPHF on Cramer-Shoup Ciphertexts}
