...
\subsection{Verifier-based PAKE Security} \label{sec:vpake-model}
...
& {\bf OT} on& \\
Recover $t_i$ if $B_\ClientSet[i]=0$ & $\stackrel{B \text{ and } \{(c_i, t_i)\}_{i\in[0,m-1]}}{\lllongleftrightarrow}$ & \\
Recover \sk from $t_i$ & & \\
