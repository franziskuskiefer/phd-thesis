...
Chapter \ref{ch:vpake} describes a framework for password registration comprising two new password registration protocols with security models and a new password-based authentication protocol in the verifier-based setting.
...
In particular, it proposes a password registration protocol for the two-server setting with an according security model as well as a new framework for two-server password-based authentication and a new security definition for \ac{2PAKE} in the \ac{UC} framework.
