...
\mynote{briefly discuss 2FA, OAUTH, etc. as alternatives and enhancements of classical password-based login}
...
\subsubsection{Strong Cryptography from Low-Entropy Secrets}
...
\mynote{discuss password based security research, practice and cryptography}
...
\mynote{discuss TLS-based architectures for passwords (discuss password challenges in this context), i.e. more technical as motivation for PACCE}
