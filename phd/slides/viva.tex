...
\begin{frame}{A Different Approach 1/2}
  \structure{Policies}
  \begin{itemize}
  ...
  \structure{Security}
  \begin{itemize}
    \item New simulation based security model
  \end{itemize}
\end{frame}

\begin{frame}{A Different Approach 2/2}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item example: \\\vspace*{1em}\begin{center}{\Large $\text{'password'}$\\[1em]becomes\\[1em]$\{p1,a1,s1,s2,o1,r1,d1\}$}\end{center}
    \end{itemize}
  \end{itemize}
