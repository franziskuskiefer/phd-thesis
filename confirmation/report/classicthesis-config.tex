...
\PassOptionsToPackage{eulerchapternumbers,listings,% drafting
				 pdfspacing,dottedtoc,%floatperchapter,%linedheaders,%subfig,
...
% ****************************************************************************************************
\newcommand{\myTitle}{Password-Based Authentication} %Human Authentication \& Cryptography from Low-Entropy Secrets\xspace}
\newcommand{\mySubtitle}{Confirmation Report\xspace}
\newcommand{\myDegree}{Master of Science (Dr.-Ing.)\xspace}
\newcommand{\myName}{Franziskus Kiefer\xspace}
\newcommand{\myProf}{Mark Manulis\xspace}
\newcommand{\myOtherProf}{Shujun li\xspace}
\newcommand{\mySupervisor}{Mark Manulis\xspace}
\newcommand{\myFaculty}{Faculty of Engineering and Physical Sciences\xspace}
\newcommand{\myDepartment}{Department of Computing\xspace}
\newcommand{\myUni}{University of Surrey\xspace}
\newcommand{\myLocation}{Guildford\xspace}
...
\PassOptionsToPackage{fleqn}{amsmath}		% math environments and more by the AMS 
 \usepackage{amsmath}
 %\usepackage{amsthm} % need also amsthm for e.g., \qed -> also gives us newtheorem!
...
\usepackage{multibib} % allow multiple bibliographies
%\newcites{pubs}{Publications} % bibliography containing own publications
%\let\oldbibsection\bibsection % store behaviour
%\renewcommand\bibsection{} % avoid pagebreak before publications
\usepackage[dvipsnames,english]{xcolor}
\usepackage[colorinlistoftodos]{todonotes} % add shiny todos
\usepackage{theorem} % for environment -> not needed due to amsthm
\usepackage{latexsym} % for Diamond symbol
\usepackage{bm} % give us some real bold math
\usepackage{pdfpages} % add whole papers
\usepackage{mdframed} % drawing frames
\usepackage{algorithm} % algorithm environment
\usepackage[noend]{algorithmic} % algorithmic ...
\usepackage{setspace} % change line spacing
\usepackage{tikz} % tikz to draw stuff
%\usepackage{tikz-qtree}
\usetikzlibrary{shapes,arrows,positioning,shadows,trees,matrix,chains,calc} % some useful tikz libraries
\usepackage{rotating} % rotate figures (sidewayfigures)
% ****************************************************************************************************
% rewrite stuff whether using draft or final version
% ****************************************************************************************************

% *** todo with nicer default color and only in drafting mode ***
\newcommand{\fk}[2][]{%
	\ifthenelse{\boolean{@drafting}}{%
		\todo[color={blue!40},size=\small,#1]{#2}\xspace%
	}{}
}

% *** 
\newcommand{\acc}[1]{\NoCaseChange{\ac{#1}}}
\newcommand{\accl}[1]{\NoCaseChange{\acl{#1}}}

% rewrite algorithm variables
\renewcommand{\algorithmicrequire}{\textbf{Input:}}
\renewcommand{\algorithmicensure}{\textbf{Output:}}
\renewcommand{\algorithmiccomment}[1]{// #1}

\newenvironment{Algorithm}[1][tbh]%
{\begin{minipage}{7cm}\centering\begin{algorithm}[H]}%
{\end{algorithm}\medskip\end{minipage}}
...
\PassOptionsToPackage{pdftex,hyperfootnotes=false,pdfpagelabels}{hyperref}
	\usepackage[backref]{hyperref}  % backref linktocpage pagebackref
\pdfcompresslevel=9
\pdfadjustspacing=1 
...
%****************************************************************************************************
% 8,5. Some environment, not available in classicthesis
% ****************************************************************************************************
...
% define own qed symbol
\newcommand\qed{\xqed{$\blacksquare$}}
