...
We distinguish between several types of passwords, we discuss in the following.
...
\begin{itemize}
	\item Why do we need human authentication
	\item What are the challenges in human authentication
	\item How to ``avoid'' these challenges
	\item Generalisation from human authentication to cryptography from low-entropy secrets
\end{itemize}
...
\section{On Provable Security}
\fk[inline]{Discuss provable security (models)}
